...
Route::middleware([RoleMiddleware::class . ':' . UserRole::ADMIN->value])->group(function () {
    ...
    Route::get('room/room-add-renter/{id}', [AdminEditRoomsController::class, 'getAddRenterToRoom'])->name('rooms.get-add-renter-to-room');
    Route::get('room/room-update/{id}', [AdminEditRoomsController::class, 'getUpdateRooms'])->name('rooms.get-update');
